package net.lldv.clansystem.components.language;
...
public class Language {
    ...
    public static void init() {
        messages.clear();
        ClanSystem.getInstance().saveResource("messages.yml");
        Config m = new Config(ClanSystem.getInstance().getDataFolder() + "/messages.yml");
