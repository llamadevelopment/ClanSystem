package net.lldv.clansystem.components.forms.simple;
...
import net.lldv.clansystem.components.forms.FormHandler;
...
public class SimpleForm {
    ...
    public void send(Player player) {
        ...
        Server.getInstance().getScheduler().scheduleDelayedTask(ClanSystem.getInstance(), () -> player.sendExperience(player.getExperience()), 20);
    }
